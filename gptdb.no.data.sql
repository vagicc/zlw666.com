...
--
-- Current Database: `gptdb`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `gptdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
--
-- Table structure for table `batch_batchtitle`
--

DROP TABLE IF EXISTS `batch_batchtitle`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=116219 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `batch_cmscontent`
--

DROP TABLE IF EXISTS `batch_cmscontent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `batch_cmscontent` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `is_regenerated` tinyint(1) NOT NULL,
  `is_reviewed` tinyint(1) NOT NULL,
  `pseudo_content` longtext,
  PRIMARY KEY (`id`),
  UNIQUE KEY `title` (`title`)
) ENGINE=InnoDB AUTO_INCREMENT=267400 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `batch_setting`
--

DROP TABLE IF EXISTS `batch_setting`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `chat_conversation` (
  ...
  `user_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `chat_conversation_user_id_15357b84_fk_auth_user_id` (`user_id`),
  CONSTRAINT `chat_conversation_user_id_15357b84_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
...
CREATE TABLE `chat_prompt` (
  ...
  `title` longtext,
  PRIMARY KEY (`id`),
  KEY `chat_prompt_user_id_b7177455_fk_auth_user_id` (`user_id`),
  CONSTRAINT `chat_prompt_user_id_b7177455_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-04-12 16:57:30
